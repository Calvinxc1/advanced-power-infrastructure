...
fluid_helpers.patch_boiler_extent("boiler", fluid_constants.power_building_pipeline_extent)
...
fluid_helpers.set_fluid_box_extent(boiler_mk2.fluid_box, fluid_constants.power_building_pipeline_extent)
fluid_helpers.set_fluid_box_extent(boiler_mk2.output_fluid_box, fluid_constants.power_building_pipeline_extent)
...
fluid_helpers.set_fluid_box_extent(boiler_mk3.fluid_box, fluid_constants.power_building_pipeline_extent)
fluid_helpers.set_fluid_box_extent(boiler_mk3.output_fluid_box, fluid_constants.power_building_pipeline_extent)
