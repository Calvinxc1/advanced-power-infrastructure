...
data.raw.item["steam-turbine"].order = "d[steam-turbine-1]"
data.raw.item["steam-turbine"].subgroup = "aer_nuclear-power"
fluid_helpers.set_description(data.raw.item["steam-turbine"], fluid_helpers.boiler_description(fluid_constants.power_building_pipeline_extent))
...
steam_turbine_mk2.subgroup = "aer_nuclear-power"
steam_turbine_mk2.order = "d[steam-turbine-2]"
steam_turbine_mk2.place_result = "aer_rubber-lined-steam-turbine"
fluid_helpers.set_description(steam_turbine_mk2, fluid_helpers.boiler_description(fluid_constants.power_building_pipeline_extent))
...
steam_turbine_mk3.subgroup = "aer_nuclear-power"
steam_turbine_mk3.order = "d[steam-turbine-3]"
steam_turbine_mk3.place_result = "aer_reinforced-steam-turbine"
fluid_helpers.set_description(steam_turbine_mk3, fluid_helpers.boiler_description(fluid_constants.power_building_pipeline_extent))
