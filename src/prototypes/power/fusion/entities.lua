...
if fusion_reactor then
  ...
  fluid_helpers.set_prototype_fluid_boxes_extent(fusion_reactor, constants.power_building_pipeline_extent)
  fluid_helpers.set_description(fusion_reactor, fluid_helpers.boiler_description(constants.power_building_pipeline_extent))
end

if fusion_generator then
  fusion_generator.next_upgrade = "aer_fusion-generator-2"
  fluid_helpers.set_prototype_fluid_boxes_extent(fusion_generator, constants.power_building_pipeline_extent)
  fluid_helpers.set_description(fusion_generator, fluid_helpers.boiler_description(constants.power_building_pipeline_extent))
end
...
fluid_helpers.set_prototype_fluid_boxes_extent(fusion_reactor_mk2, constants.power_building_pipeline_extent)
fluid_helpers.set_description(fusion_reactor_mk2, fluid_helpers.boiler_description(constants.power_building_pipeline_extent))
...
fluid_helpers.set_prototype_fluid_boxes_extent(fusion_generator_mk2, constants.power_building_pipeline_extent)
fluid_helpers.set_description(fusion_generator_mk2, fluid_helpers.boiler_description(constants.power_building_pipeline_extent))
