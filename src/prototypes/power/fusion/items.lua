...
fusion_reactor.localised_description = fluid_helpers.boiler_description(constants.power_building_pipeline_extent)
...
fusion_generator.localised_description = fluid_helpers.boiler_description(constants.power_building_pipeline_extent)
...
fusion_reactor_mk2.localised_description = fluid_helpers.boiler_description(constants.power_building_pipeline_extent)
...
fusion_generator_mk2.localised_description = fluid_helpers.boiler_description(constants.power_building_pipeline_extent)
